...
rectangle1 = canvas.create_rectangle(200, 300, 400, 350, fill='grey')
...
for i in range(string):
    for j in range(column):
        ...
        colors = choice(['red', 'orange',  'yellow', 'green', 'blue', 'purple', 'magenta'])
...
def ball_movement():
    ...
    if 200 < ball_x < 400 and 300 < ball_y < 350:
        ball_vy = -ball_vy
